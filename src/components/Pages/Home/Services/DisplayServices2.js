...
const {handledetails}=props
    return (
      ...
      <button onClick={()=>handledetails(_id)} class="mt-2 py-2 px-4 text-white bg-indigo-500  font-bold rounded-lg shadow-md hover:bg-indigo-600 transition duration-300">{cartPlus} <span className='pl-1'>Book</span></button>
